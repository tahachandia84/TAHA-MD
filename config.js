...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || getConfig("BOT_NAME") || "TAHA-MD",  // Bot's display name
    MODE: getConfig("MODE") || process.env.MODE || "public",        // Bot mode: public/private/group/inbox
    REPO: process.env.REPO || "https://github.com/tahachandia84/TAHA-MD/forkhttps://github.com/tahachandia84/TAHA-MD",  // Bot's GitHub repo
    BAILEYS: process.env.BAILEYS || "@whiskeysockets/baileys",  // Bot's BAILEYS

    // ===== OWNER & DEVELOPER SETTINGS =====
    OWNER_NUMBER: process.env.OWNER_NUMBER || "923474771404",  // Owner's WhatsApp number
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "Taha Khan",           // Owner's name
    DEV: process.env.DEV || "923474771404",                     // Developer's contact number
    ...
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*TAHA-MD VIEWED YOUR STATUS 🤖*",  // Status reply message
    ...
    STICKER_NAME: process.env.STICKER_NAME || "Taha Khan",     // Sticker pack name
    ...
    DESCRIPTION: process.env.DESCRIPTION || "*© CREATER Taha Khan*",  // Bot description
